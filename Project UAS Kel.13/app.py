...
<style>
    ...
    .stApp {
        background: #72BCD4; /* biru */
    }
    /* Sidebar putih */
    .css-1d391kg { /* Kelas Streamlit untuk sidebar */
        background: blue; /* biru */
        color: black; /* Teks hitam */
        border-radius: 0;
        padding: 20px;
    }
    ...
    /* Responsif: Tetap biru di mobile */
...
if page == "Home":
    ...
    <style>
        ...
        .feature-list li:hover {
            ...
            background-color: #999D; /* Abu-abu muda saat hover */
    ...
    st.image("img1.jpg.jpeg", use_container_width=True)
