...
if menu == 'luas persegi':
    st.write ('[ini halaman untuk menghitung luas persegi]:balloon::balloon:')
    ...
    if st.button('hitung'):
        ...
        st.image('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvnU93yw54EG4p3cL7lMuWFeCGlkPv0co7cA&s', caption='gambar segitiga')
